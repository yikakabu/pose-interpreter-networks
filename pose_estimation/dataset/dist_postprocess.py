...
parser.add_argument('--train_subset_size', type=int, default=10240, help='group train images into train_subset_size images per directory')
parser.add_argument('--process_val', action='store_true', help='whether to generate val set')
parser.set_defaults(process_val=True)  # should download provided val set to match numbers in paper
